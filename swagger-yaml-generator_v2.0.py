...
listDataModels = "http://bit.ly/listdatamodels"
dataModelsDict = open_json(listDataModels)["officialList"]
...
for repo in dataModelsDict:
    repoName = repo["repoName"]
    if repoName in filterRepo:
        echo("repoName", repoName)
        for dataModel in repo["dataModels"]:
            if dataModel in filterDataModel and allowFilterDataModel:
